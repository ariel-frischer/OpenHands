...
interact with it via a [friendly CLI](https://docs.all-hands.dev/modules/usage/how-to/cli-mode) (try `make cli`),
or a [Text User Interface (TUI)](https://docs.all-hands.dev/modules/usage/how-to/tui-mode) (try `make tui`),
