...
class TestChatPanel:
    ...
    @patch('openhands.tui.panels.chat_panel.ptg.terminal')
    def test_update_chat_display_no_event_stream(self, mock_terminal, chat_panel, mock_session_manager):
    ...
    def test_handle_terminal_resize_no_active_session(self, chat_panel, mock_session_manager):
    ...
    @pytest.mark.asyncio
    async def test_send_message(self, chat_panel, mock_session_manager, mock_event_manager):
    ...
    @patch('openhands.tui.panels.chat_panel.ptg.terminal')
    def test_responsive_layout_small_terminal(self, mock_terminal, chat_panel, mock_session_manager):
    ...
    def test_message_wrapping_narrow_terminal(self, mock_terminal, chat_panel):
        ...
        wrapped_content = chat_panel.wrap_message_content(message.content, available_width - 6)
