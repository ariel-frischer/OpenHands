...
class FileOperations:
    ...
    @staticmethod
    def write_text_file(file_path: Union[Path, str], content: str, encoding: str = 'utf-8') -> bool:
    ...
    @staticmethod
    def write_json_file(file_path: Union[Path, str], data: Any, indent: int = 2) -> bool:
    ...
    @staticmethod
    def append_to_file(file_path: Union[Path, str], content: str, encoding: str = 'utf-8') -> bool:
